...
load --exec $HOME/myexpos/expl/samples/create.xsm
load --exec $HOME/myexpos/expl/samples/del_f.xsm
load --exec $HOME/myexpos/expl/samples/filerd1.xsm
...
load --module 3 $HOME/myexpos/spl/spl_progs/file_manager_mod_3.xsm
...
load --int=15 $HOME/myexpos/spl/spl_progs/ShutdownSysCall_int15.xsm
